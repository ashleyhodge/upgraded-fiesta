  ...
  return (
    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
        <a href="/" class="flex items-center">
            ...
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Stanley Jane</span>
        </a>
    ...
    <div class="py-3 px-4 mx-auto max-w-screen-xl md:px-6">
        <div class="flex items-center">
            <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                <li>
                    <a href="#" class="text-indigo-900 dark:text-white hover:underline" aria-current="page">Home</a>
                </li>
                <li>
                    <a href="#" class="text-indigo-900 dark:text-white hover:underline">Shop</a>
                </li>
                <li>
                    <a href="#" class="text-gray-900 dark:text-white hover:underline">Blog</a>
                </li>
                <li>
                    <a href="#" class="text-gray-900 dark:text-white hover:underline">Book Astrological Reading!</a>
                </li>
            </ul>
        </div>
    </div>
